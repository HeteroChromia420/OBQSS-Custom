...
sudo apt install wget unzip dunst xfce4-whiskermenu-plugin xfce4-appmenu-plugin vala-panel-appmenu appmenu* caffeine breeze-cursor-theme wget fonts-noto* kdeconnect plank zram-tools -y --no-install-recommends --no-install-suggests 
...
sudo apt purge --auto-remove xfce4-notifyd tint2 pnmixer celluloid quodlibet gimp mpv youtube-dl epiphany-browser libreoffice 
